...
function formatPostRow($row, $scores = [], $dislikedTypes = [], $givenFeedbackPosts = []) {
    ...
    $fieldsToRemove = [
        'username', 'full_name', 'avatar_url', 'is_premium', // Main user flat fields
        'op_id', 'op_content', 'op_quote_text', 'op_comment_text', 'op_source', 'op_author',
        'op_created_at', 'op_user_id', 'op_username', 'op_full_name', 'op_avatar_url', 'op_is_premium',
        'op_image_url', 'op_content_type', 'op_content_id', 'op_like_count', 'op_comment_count',
        'op_repost_count', 'op_is_liked', 'op_is_reposted', 'op_is_saved', 'op_topic_id', 'op_topic_name', 'op_view_count'
    ];
