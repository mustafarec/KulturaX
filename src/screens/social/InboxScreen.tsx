...
// Mock data for requests since backend doesn't support it yet
const mockRequests = [
    {
        id: 101,
        user: {
            name: 'Aylin Özkan',
            avatar: 'https://images.unsplash.com/photo-1704726135027-9c6f034cfa41?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400',
        },
        message: 'Merhaba! Kafka üzerine yaptığın yorumları çok beğendim.',
        time: '10 dk',
    },
    {
        id: 102,
        user: {
            name: 'Burak Yıldırım',
            avatar: 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400',
        },
        message: 'Paylaştığın kitap listesine bayıldım!',
        time: '2 sa',
    }
];
...
export const InboxScreen = () => {
    ...
    const handleAcceptRequest = (id: number) => {
        ...
        // Add to conversations locally for demo
        fetchInbox();
    };
        ...
        <View style={styles.requestItem}>
            <View style={styles.requestContent}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <Text style={styles.lastMessage} numberOfLines={2}>{item.message}</Text>
                </View>
            </View>
