        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.content}>
                ...
                <TouchableOpacity style={styles.headerImageContainer} onPress={handleHeaderSelect}>
                    <Image
                        source={{ uri: headerAsset ? headerAsset.uri : (user?.header_image_url || 'https://images.unsplash.com/photo-1507842217121-9e96e4430330?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80') }}
                ...
                <View style={styles.avatarSection}>
                    <TouchableOpacity onPress={handleAvatarSelect}>
                        <Image
                            source={{ uri: avatarAsset ? avatarAsset.uri : (user?.avatar_url || 'https://via.placeholder.com/150') }}
                            style={styles.avatar}
                        />
