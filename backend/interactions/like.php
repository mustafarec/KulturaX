                    ...
                    if ($ownerId !== $senderId) {
                        ...
                        if (!$notifStmt->execute()) {
                            ...
                            if (file_exists('../notifications/OneSignal.php')) {
                                ...
                                $oneSignal->sendToUser($ownerId, $title, $message, array("type" => "like", "post_id" => $data->post_id));
                            } else {
                                file_put_contents('../debug_log.txt', date('Y-m-d H:i:s') . " - OneSignal.php not found\n", FILE_APPEND);
                            }
                        }
                    } else {
